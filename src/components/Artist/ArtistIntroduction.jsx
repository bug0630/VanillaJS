        ...
        <div className='artist-info'>
          ...
          <div className='gallery'>
            ...
            <div className='gallery-container'>
              <li>
              <img className='gallery-item gallery-item-1' src={`${process.env.PUBLIC_URL}/images/art_img/img1.webp`} alt="1" />
              <img className='gallery-item gallery-item-2' src={`${process.env.PUBLIC_URL}/images/art_img/img2.webp`} alt="2" />
              <img className='gallery-item gallery-item-3' src={`${process.env.PUBLIC_URL}/images/art_img/img3.webp`} alt="3" />
              <img className='gallery-item gallery-item-4' src={`${process.env.PUBLIC_URL}/images/art_img/img4.webp`} alt="4" />
              <img className='gallery-item gallery-item-5' src={`${process.env.PUBLIC_URL}/images/art_img/img5.webp`} alt="5" />
            </li>
            </div>
            </ul>
