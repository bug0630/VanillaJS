...
const ArtistInfo = (props) => {
  ...
  return (
    <div className="artist_detail">
      ...
      <img src={product && product.profile_img} alt="" className="artistInfo_img" />
      
        <div>
          <div className="infoItem">
            <div className="artistInfo_name">{product && product.artist_name}</div>
          </div>
          ...
          <div className='instagram-link'>
            ...
            <a href={product && product.insta_link} target="_blank" rel="noopener noreferrer"
            >Instagram</a></p>
          </div>
