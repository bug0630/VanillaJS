...
const AuctionPage = () => {
  ...
  const artwork = {
    ...
    description:
      'Elvin Larsson is known for his representational street view artworks',
    estimatedPrice: 5000,
    startingBid: 2500,
    ...
    <div className="auction-page">
      ...
      <div className="artwork-container">
        <img
          ...
          src="https://media.mutualart.com/Images/2020_06/14/09/094726816/bb707499-9640-41bb-b511-848015876fb2.Jpeg?w=768"
          alt="Artwork"
        />
      </div>
          ...
          <div className="timer-container">
            <div className="timer-frame">
              <p className="remaining-time">
                Closing:{formatRemainingTime(remainingTime)}
              </p>
            </div>
          </div>
        </div>
