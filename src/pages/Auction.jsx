 ...
 const [selectedArt, setSelectedArt] = useState(null);
          ...
          <div className="tcell">
            <div className="curtain-wrapper">
              <div className={`curtain ${curtainOpen ? 'open' : ''}`}>
                <div className="panel-left"></div>
                <div className="panel-right"></div>
                <div className="jacket" title="Play" onClick={toggleCurtain}></div>
              </div>
            </div>
          </div>
        </div> */}
  ...
  {selectedArt && (
    ...
    <div className="artwork-img-section">
      <img src={selectedArt.bid_art_img ? selectedArt.bid_art_img : ''} className="artwork-image" />
    </div>
      <div className="artwork-info"> 
        <h2 className="artwork-title">{selectedArt.bid_art_title}</h2>
        <h3 className="artist">Artist: {selectedArt.artist}</h3>
        <p className="description">Description: {selectedArt.description}</p>
        
        <div className="price-section">
          <div>Estimated Price:
          <span className="price-value">${selectedArt.bid_estimate_price}</span>
          </div> 
          <div>Starting Price:
          <span className="price-value">${selectedArt.bid_starting_price}</span>
          </div>
        </div>
        ...
        {bidDetails.amount && (
          <div className="bid-details">
            ...
            <p><strong>Amount:</strong> ${bidDetails.amount}</p>
            <p><strong>Name:</strong> {bidDetails.name}</p>
          </div>
        )}
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          <form>
            <div className="mb-3">
              <label htmlFor="bidAmount" className="form-label">경매 가격</label>
            ...
            <div className="mb-3">
              <label htmlFor="bidderName" className="form-label">성함</label>
            ...
            <div className="mb-3">
              <label htmlFor="bidderEmail" className="form-label">이메일</label>
            ...
            <div className="mb-3">
              <label htmlFor="bidderPhone" className="form-label">전화번호</label>
  ...
  <Modal.Body>
    ...
    <div className="bid-details">
      ...
      <p><strong>Phone:</strong> {bidDetails.phone}</p>
    </div>
  )}
  </Modal.Body>
  <Modal.Footer>
